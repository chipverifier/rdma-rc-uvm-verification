...
extern "C" {
#endif
void  hs_0_M_0_21__tb_rdma_rc_pdu_daidir (UB  * pcode, scalar  val);
void  hs_0_M_0_0__tb_rdma_rc_pdu_daidir (UB  * pcode, scalar  val);
void  hs_0_M_0_1__tb_rdma_rc_pdu_daidir (UB  * pcode, scalar  val, U  I677, scalar  * I1303, U  did);
void  hs_0_M_0_2__tb_rdma_rc_pdu_daidir (UB  * pcode);
void  hs_0_M_0_11__tb_rdma_rc_pdu_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_21__tb_rdma_rc_pdu_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_0__tb_rdma_rc_pdu_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_1__tb_rdma_rc_pdu_daidir (UB  * pcode, scalar  val, U  I677, scalar  * I1303, U  did);
void  hs_0_M_1_2__tb_rdma_rc_pdu_daidir (UB  * pcode);
void  hs_0_M_1_11__tb_rdma_rc_pdu_daidir (UB  * pcode, scalar  val);
